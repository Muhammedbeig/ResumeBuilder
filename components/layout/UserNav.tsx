      ...
      <Dialog open={isSettingsOpen} onOpenChange={setIsSettingsOpen}>
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Button
              variant="ghost"
              className="relative h-10 rounded-full px-1.5"
            >
              <span
        ...
        <DialogContent className="sm:max-w-[425px]">
          ...
          >
            <TabsList
              className={`grid w-full ${canChangePassword ? "grid-cols-3" : "grid-cols-2"}`}
            >
            ...
            <TabsContent value="general" className="space-y-4 py-4">
              ...
              {isGoogleSession && (
                <p className="text-[0.8rem] text-amber-600 dark:text-amber-400 font-medium">
                  You signed in with Google. You can set a password here without
                  entering an old password.
                </p>
              )}
            ...
            {canChangePassword && (
              <TabsContent value="security" className="space-y-4 py-4">
                ...
                <div className="space-y-2">
                  ...
                  />
                  <p className="text-[0.8rem] text-muted-foreground">
                    Use 8-72 chars with uppercase, lowercase, number, and
                    special character.
                  </p>
                </div>
                <div className="space-y-2">
