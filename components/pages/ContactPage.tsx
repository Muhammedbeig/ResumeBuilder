...
export function ContactPage({
  ...
  const contactDetails = [
    companyEmail
      ...
      : null,
    companyTel1
      ? { label: "Phone", value: companyTel1, href: `tel:${companyTel1}` }
      : null,
    companyTel2
      ? { label: "Alt Phone", value: companyTel2, href: `tel:${companyTel2}` }
      : null,
        ...
        <div className="text-center max-w-3xl mx-auto">
          ...
          {normalizedIntroHtml ? (
            ...
            <p className="mt-4 text-gray-600 dark:text-gray-300">
              Your message is stored directly in the Admin Panel so our support
              team can reply faster.
            </p>
          )}
          ...
          >
            <Card className="border-gray-200 dark:border-gray-800">
              <CardHeader>
                ...
                <CardDescription>
                  Fields are required. We use this information only to respond
                  to your request.
                </CardDescription>
              </CardHeader>
              <CardContent>
