          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-500 dark:text-gray-400">
                Here is how your resume performs against Applicant Tracking
                Systems.
              </p>
            </div>
                      ...
                      >
                        <CardHeader className="pb-2">
                          <CardTitle className="text-base capitalize flex justify-between">
                            {key.replace("_", " ")}
                            <span
                              className={`text-sm ${getScoreColor(data.score)}`}
                            >
                              {data.score}/100
                            </span>
                          </CardTitle>
    ...
    <div className="min-h-screen pt-24 pb-12 px-4 sm:px-6 lg:px-8 bg-gray-50 dark:bg-gray-900 flex items-center justify-center">
      ...
      <div className="max-w-4xl w-full space-y-8">
        <div className="text-center space-y-4">
          ...
          >
            Get a detailed analysis of your resume's compatibility with
            Applicant Tracking Systems. Identify strengths, weaknesses, and
            missing keywords.
          </motion.p>
        </div>
              ...
              <CardContent className="p-8 flex flex-col items-center text-center h-full justify-center space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400">
                    Upload your existing resume (PDF) to get an instant
              ...
              <Card className="h-full border-2 border-transparent bg-white dark:bg-gray-800 hover:shadow-xl transition-all duration-300 group">
                <CardContent className="p-8 flex flex-col items-center text-center h-full justify-center space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400">
                      Don't have a resume? Choose from our professional
                      templates and build one that passes ATS.
                    </p>
                  </div>
                  <Button
                    variant="outline"
                    className="w-full group-hover:bg-cyan-50 dark:group-hover:bg-cyan-900/20 group-hover:text-cyan-700 dark:group-hover:text-cyan-300 group-hover:border-cyan-200 dark:group-hover:border-cyan-800"
                  >
