  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="text-xl text-slate-600 mb-4 font-light tracking-wider">
        ...
        <div className="flex flex-wrap justify-center gap-x-6 gap-y-2 text-sm text-slate-600 font-sans">
          {basics.email && (
            <span className="flex items-center gap-1">{basics.email}</span>
          )}
          {basics.phone && (
            <span className="flex items-center gap-1">{basics.phone}</span>
          )}
          {basics.location && (
            <span className="flex items-center gap-1">{basics.location}</span>
          )}
          {basics.linkedin && (
