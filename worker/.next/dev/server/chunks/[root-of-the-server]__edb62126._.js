...
"[project]/worker/app/api/ai/ats-check/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    const access = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$ai$2d$access$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requirePaidAiAccess"])(req);
    ...
    try {
        ...
        if (file.type === "application/pdf") {
            text = await withTimeout((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$pdf$2d$text$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["extractPdfText"])(buffer, 1), 45_000, "PDF extraction timed out");
        } else {
            // Fallback for plain text
            text = buffer.toString("utf-8");
        }
        text = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$limits$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["truncateText"])(text, resourceSettings.limits.aiText);
        if (!text || !text.trim()) {
      ...
      ${text}
    `;
        const result = await withTimeout(model.generateContent(prompt), 60_000, "ATS analysis timed out");
...
//# sourceMappingURL=%5Broot-of-the-server%5D__edb62126._.js.map