...
"[project]/worker/app/api/ai/tailor/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    ...
    const jobText = typeof jobDescription === "string" ? jobDescription : [
        ...
        Array.isArray(jobDescription?.requirements) ? `Requirements: ${jobDescription.requirements.join(", ")}` : ""
    ].filter(Boolean).join("\n");
    const limitedJobText = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$limits$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["truncateText"])(jobText, resourceSettings.limits.aiText);
    try {
  ...
  "suggestions": [
    {
      ...
      "keywords": string[]
        ...
        const data = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$ai$2d$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["extractJson"])(response.text());
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3e4c4444._.js.map