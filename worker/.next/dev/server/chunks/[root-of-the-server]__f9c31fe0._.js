...
"[project]/worker/app/api/ai/suggestions/responsibilities/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    ...
    const rateLimitResponse = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$rate$2d$limit$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["rateLimit"])(request, {
        prefix: "ai-suggestions-responsibilities",
        limit: resourceSettings.rateLimits.ai,
        windowMs: resourceSettings.rateLimits.windowMs
    });
    if (rateLimitResponse) return rateLimitResponse;
    const body = await request.json().catch(()=>({}));
    const jobTitle = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$limits$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["truncateText"])(String(body?.jobTitle || "").trim(), resourceSettings.limits.aiText);
    const description = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$limits$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["truncateText"])(String(body?.description || "").trim(), resourceSettings.limits.aiText);
    if (!jobTitle) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
Format:
{
  "responsibilities": ["string"]
        ...
        try {
            data = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$ai$2d$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["extractJson"])(text);
        } catch (e) {
        ...
        const cleaned = Array.isArray(data.responsibilities) ? data.responsibilities.map((item)=>typeof item === "string" ? item.trim() : "").filter((item)=>item.length > 0) : [];
        if (cleaned.length === 0) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                responsibilities: []
            });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f9c31fe0._.js.map