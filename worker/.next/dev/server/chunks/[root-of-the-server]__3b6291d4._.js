...
"[project]/worker/app/api/ai/suggestions/skills/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
Format:
{
  ...
  "softSkills": ["string"]
        ...
        try {
            suggestions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$ai$2d$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["extractJson"])(text);
        } catch (e) {
        ...
        const hardSkills = Array.isArray(suggestions.hardSkills) ? suggestions.hardSkills.map((item)=>typeof item === "string" ? item.trim() : "").filter((item)=>item.length > 0) : [];
        const softSkills = Array.isArray(suggestions.softSkills) ? suggestions.softSkills.map((item)=>typeof item === "string" ? item.trim() : "").filter((item)=>item.length > 0) : [];
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            hardSkills,
            softSkills
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3b6291d4._.js.map