...
const steps = [
  {
    ...
    description:
      "Create your account in seconds and browse our collection of ATS-friendly templates. Pick the one that matches your style and industry.",
    features: [
  ...
  },
  {
    ...
    description:
      "Our AI analyzes your experience and suggests powerful, achievement-focused bullet points using proven frameworks like STAR and CAR.",
    features: [
  ...
  },
  {
    ...
    description:
      "Paste a job description and watch as our AI identifies missing keywords and rewrites your resume to match perfectly.",
    features: [
  ...
  },
  {
    ...
    description:
      "Download your resume as a PDF or share your professional profile link. Start getting more interview calls!",
    features: [
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
            Get your dream job in 4 simple steps. Our AI does the heavy lifting
          ...
          {steps.map((step, index) => {
            ...
            return (
              ...
              >
                ...
                >
                  <div
                    className={`space-y-4 ${isEven ? "lg:ml-auto" : "lg:mr-auto"} max-w-lg`}
                  >
