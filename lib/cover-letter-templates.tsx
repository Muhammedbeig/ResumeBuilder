    ...
    >
      ...
      <div className="border-b-2 pb-6 mb-8" style={{ borderColor: themeColor }}>
        ...
        <div className="flex justify-between mt-4 text-sm font-medium text-gray-500">
          ...
          <span>
            {data.personalInfo.city}, {data.personalInfo.zipCode}
          </span>
        </div>
      </div>
...
export const coverLetterTemplates: CoverLetterTemplate[] = [
  {
    ...
    name: "Modern Clean",
    description:
      "A clean and contemporary design suitable for startups and tech companies.",
  ...
  },
  {
    ...
    description:
      "A traditional layout perfect for corporate and executive roles.",
