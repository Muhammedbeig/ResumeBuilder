    ...
    <main className="min-h-screen bg-gray-50 dark:bg-gray-950 pt-24 pb-16">
      <section className="max-w-6xl mx-auto px-6">
        <div className="text-center max-w-3xl mx-auto">
          <p className="text-sm font-semibold text-purple-600 uppercase tracking-widest">About ResuPro</p>
          ...
          <p className="mt-4 text-gray-600 dark:text-gray-300">
            ResuPro combines smart structure, expert guidance, and AI powered suggestions so every
