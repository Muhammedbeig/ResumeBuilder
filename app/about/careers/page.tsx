...
const values = [
  {
    ...
    description:
      "Every decision starts with what makes job seekers more confident and effective.",
  },
  {
    title: "Bias for clarity",
    description:
      "We document, communicate, and keep work moving with light weight processes.",
  },
  {
      ...
      <section className="max-w-6xl mx-auto px-6">
        <div className="text-center max-w-3xl mx-auto">
          ...
          <p className="mt-4 text-gray-600 dark:text-gray-300">
            Join a team that believes great careers start with clear
            storytelling. We are building tools that make job search feel
        ...
        <div className="mt-16 rounded-2xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-800 dark:bg-gray-900">
          ...
          <p className="mt-4 text-sm text-gray-500 dark:text-gray-400">
            Interested? Share your resume with a short note about the role you
            want to grow into.
          </p>
        </div>
      </section>
