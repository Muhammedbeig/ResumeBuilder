...
export default function AIResumeOptimizerPage() {
  ...
  const workflowSteps = [
    {
      ...
      description:
        "Paste your resume text or upload a PDF. Our AI will handle the parsing and extraction automatically.",
      icon: Upload,
    ...
    },
    {
      title: "Deep Analysis",
      description:
        "Our AI compares your resume against the job description to identify keyword gaps and score your compatibility.",
      icon: Sparkles,
      color: "text-cyan-600",
    ...
    },
    {
      ...
      description:
        "Select from our range of ATS-friendly templates that best suit your professional style and the job requirements.",
      icon: LayoutTemplate,
    ...
    },
    {
      title: "Live Preview",
      description:
        "Review your optimized resume in real-time. Fine-tune any details before downloading your job-winning document.",
      icon: Eye,
  ...
  const handleAddKeyword = (keyword: string) => {
    ...
    const newMissing = analysisResults.missingKeywords.filter(
      (k) => k !== keyword,
    );
    ...
    if (parsedResume) {
      const skillsIndex = parsedResume.skills.findIndex(
        (s) =>
          s.name.toLowerCase().includes("skill") ||
          s.name.toLowerCase().includes("technic"),
      );
  ...
  const handleProceedToTemplate = () => {
    if (parsedResume && analysisResults) {
      ...
      const matchedLower = new Set(
        analysisResults.matchedKeywords.map((k) => k.toLowerCase()),
      );
      ...
      const tailoredSkills = parsedResume.skills
        .map((group) => ({
          ...
          skills: group.skills.filter((s) => {
            ...
            return Array.from(matchedLower).some(
              (k) => skillLower.includes(k) || k.includes(skillLower),
            );
          }),
        }))
  ...
  return (
    <>
      ...
      <div
        ref={containerRef}
        className="relative min-h-screen pt-24 pb-20 overflow-hidden bg-gray-50 dark:bg-gray-950 flex flex-col"
      >
            ...
            >
              <div className="relative w-64 h-64 flex items-center justify-center">
                <motion.div
                  ...
                  className="absolute inset-0 border-4 border-dashed border-purple-500/20 rounded-full"
                />
                <motion.div
                  ...
                  className="absolute inset-4 border-2 border-purple-500/30 rounded-full bg-purple-500/5"
                />
                <div className="relative">
                  <motion.div
                    animate={{ scale: [1, 1.2, 1], rotate: [0, 10, -10, 0] }}
                    transition={{ duration: 3, repeat: Infinity }}
                    className="w-24 h-24 bg-gradient-to-tr from-purple-600 to-cyan-500 rounded-3xl shadow-2xl shadow-purple-500/40 flex items-center justify-center"
                  >
              ...
              <div className="mt-12 text-center max-w-md px-6">
                ...
                <p className="mt-4 text-gray-500 dark:text-gray-400 text-sm animate-pulse">
                  Our AI is hard at work perfectioning your career path...
                </p>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12 space-y-6">
              ...
              >
                <Badge
                  variant="secondary"
                  className="px-4 py-1.5 rounded-full bg-purple-100 dark:bg-purple-900/30 border border-purple-200 dark:border-purple-800 text-purple-700 dark:text-purple-300"
                >
              ...
              >
                ...
                <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto leading-relaxed">
                  Upload your PDF resume or paste the text, along with the job
                  description. Our AI will analyze both and suggest specific
                  changes to help you beat ATS systems and land more interviews.
                </p>
              </motion.div>
            </div>
            ...
            <motion.div
              ...
              className="flex justify-center mb-16 overflow-x-auto py-4"
            >
                ...
                {steps.map((s, i) => (
                  ...
                  `}
                    ...
                    <div className="ml-4 mr-4 hidden md:block">
                      <p
                        className={`text-xs font-bold uppercase tracking-wider ${step === s.number ? "text-purple-600 dark:text-purple-400" : "text-gray-400"}`}
                      >
                        Step {s.number}
                      </p>
                      <p
                        className={`text-sm font-bold ${step === s.number ? "text-gray-900 dark:text-white" : "text-gray-500"}`}
                      >
                        {s.label}
                      </p>
                    </div>
                    {i < steps.length - 1 && (
                      <div
                        className={`w-12 h-0.5 mx-2 transition-colors duration-300 hidden md:block ${step > s.number ? "bg-green-500" : "bg-gray-200 dark:bg-gray-800"}`}
                      />
                    )}
                  </div>
                ))}
              ...
              <div className="space-y-20">
                  ...
                  <Card className="p-6 border-2 border-transparent hover:border-purple-500/20 transition-all duration-300">
                    <div className="flex justify-between items-start mb-6">
                      ...
                      <div className="flex bg-gray-100 dark:bg-gray-800 rounded-lg p-1">
                        <button
                          ...
                          className={`px-3 py-1 text-xs font-medium rounded-md transition-all ${inputType === "paste" ? "bg-white dark:bg-gray-700 text-gray-900 dark:text-white shadow-sm" : "text-gray-500"}`}
                        >
                          Paste
                        </button>
                        <button
                          onClick={() => setInputType("upload")}
                          className={`px-3 py-1 text-xs font-medium rounded-md transition-all ${inputType === "upload" ? "bg-white dark:bg-gray-700 text-gray-900 dark:text-white shadow-sm" : "text-gray-500"}`}
                        >
                          Upload PDF
                        </button>
                      </div>
                    ...
                    {inputType === "upload" && resumeText && !isUploading ? (
                      ...
                      <Textarea
                        ...
                        className="min-h-[300px] resize-none bg-gray-50 dark:bg-gray-900/50 border-gray-200 dark:border-gray-800 focus:ring-purple-500"
                        value={resumeText}
                    ...
                    {hasJobUrlAccess && (
                      <div className="mb-4 space-y-3">
                        ...
                        <p className="text-xs text-gray-400">
                          Works with most job boards. Paste any public job link
                          to auto-extract the description.
                        </p>
                      </div>
                    )}
                    <Textarea
                ...
                <div className="text-center mb-24">
                  <Button
                    ...
                    className="bg-gradient-to-r from-purple-600 to-cyan-500 hover:from-purple-700 hover:to-cyan-600 text-white rounded-full px-12 py-6 text-lg font-bold shadow-xl shadow-purple-500/20 transition-all hover:scale-105"
                  >
                    {isAnalyzing ? (
                      <>
                      ...
                      <>
                        <Sparkles className="w-5 h-5 mr-2" /> Analyze & Get
                        Suggestions
                      </>
                    )}
                  </Button>
                  ...
                  {[
                    {
                      ...
                      description:
                        "Over 75% of resumes are rejected by Applicant Tracking Systems. Our AI identifies missing keywords to help you pass.",
                    },
                    {
                      icon: Search,
                      ...
                      description:
                        "Each job posting contains specific keywords that hiring managers look for. Our AI extracts these and shows you where to add them.",
                    },
                    {
                      icon: Trophy,
                      ...
                      description:
                        "Generic job descriptions don't impress recruiters. Our AI helps you transform responsibilities into quantifiable achievements.",
                    },
                    {
                      icon: Zap,
                      ...
                      description:
                        "Get a comprehensive analysis in under a minute. See your ATS match score and actionable suggestions immediately.",
                    },
                  ].map((f, i) => (
                    <motion.div
                      key={i}
                    ...
                    >
                      <div
                        className={`absolute inset-0 rounded-2xl bg-gradient-to-r ${f.color} opacity-0 group-hover:opacity-5 transition-opacity duration-500`}
                      />
                      <div
                        className={`w-14 h-14 rounded-xl bg-gradient-to-r ${f.color} flex items-center justify-center mb-6 shadow-lg shadow-gray-200 dark:shadow-none transform group-hover:scale-110 group-hover:rotate-3 transition-transform duration-500`}
                      >
                ...
                <div className="py-20 border-t border-gray-200 dark:border-gray-800">
                  <div className="text-center mb-16">
                    ...
                    <p className="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
                      Optimize your resume in 4 simple steps and increase your
                      interview chances.
                    </p>
                  </div>
                  <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                    {workflowSteps.map((s, i) => (
                      <motion.div
                        ...
                        viewport={{ once: true }}
                        transition={{ delay: i * 0.1 }}
                        className="p-8 rounded-3xl bg-white dark:bg-gray-900/50 border border-gray-100 dark:border-gray-800 text-center"
                      >
                        <div
                          className={`w-14 h-14 ${s.bg} ${s.color} rounded-2xl flex items-center justify-center mb-6 mx-auto`}
                        >
                  ...
                  <Card className="lg:col-span-2 border-0 shadow-lg bg-white dark:bg-gray-800">
                    <CardHeader>
                      <CardTitle className="flex items-center gap-2">
                        <Sparkles className="w-5 h-5 text-purple-500" /> Missing
                        Keywords
                      </CardTitle>
                      <CardDescription>
                        Consider adding these keywords to improve your match
                        rate for relevant roles. Click a keyword to mark it as
                        added.
                      </CardDescription>
                    </CardHeader>
                    <CardContent>
                      <div className="space-y-8">
                            ...
                            {analysisResults.missingKeywords.length > 0 ? (
                              <>
                                {analysisResults.missingKeywords
                                  .slice(0, isKeywordsExpanded ? undefined : 10)
                                  .map((kw, i) => (
                                    <Badge
                                      key={i}
                                      variant="secondary"
                              ...
                              <span className="text-sm text-green-500 flex items-center gap-2 bg-green-50 dark:bg-green-900/20 px-3 py-2 rounded-lg">
                                <Check className="w-4 h-4" /> All critical
                                keywords found!
                              </span>
                            )}
                          </div>
                        ...
                        <div>
                          ...
                          <div className="flex flex-wrap gap-2">
                            {analysisResults.matchedKeywords
                              .slice(0, 15)
                              .map((kw, i) => (
                                <Badge
                                  key={i}
                                  variant="secondary"
                                  className="bg-green-50 text-green-700 dark:bg-green-900/20 dark:text-green-300 border border-green-200 dark:border-green-800/50 px-3 py-1 text-sm font-normal"
                                >
                                  {kw}
                                </Badge>
                              ))}
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    {analysisResults.suggestions.length > 0 && (
                      <Button
                        ...
                        className="bg-gradient-to-r from-purple-600 to-cyan-500 text-white shadow-lg"
                      >
                        <CheckCheck className="w-4 h-4 mr-2" /> Apply All
                        Suggestions
                      </Button>
                    )}
                  </div>
                  ...
                  {analysisResults.suggestions.length > 0 ? (
                    <div className="grid gap-6">
                      {analysisResults.suggestions.map((suggestion, index) => (
                        <Card
                          key={index}
                          className="p-6 border-l-4 border-l-purple-500 shadow-md"
                        >
                          <div className="flex flex-col md:flex-row gap-6">
                            <div className="flex-1 space-y-4">
                              ...
                              <div>
                                <h4 className="text-xs font-bold text-purple-600 dark:text-purple-400 uppercase mb-2 flex items-center gap-2">
                                  <Sparkles className="w-3 h-3" /> AI Optimized
                                </h4>
                                <p className="text-gray-900 dark:text-white bg-purple-50 dark:bg-purple-900/10 border border-purple-100 dark:border-purple-800/30 p-3 rounded-lg text-sm font-medium">
                ...
                <div className="flex flex-col lg:flex-row gap-8 h-[calc(100vh-200px)]">
                  ...
                  <div className="lg:w-1/3 space-y-6">
                    <div>
                      ...
                      <p className="text-gray-500">
                        Review your tailored resume before saving.
                      </p>
                    </div>
                    ...
                    <Card className="bg-purple-50 dark:bg-purple-900/10 border-purple-100 dark:border-purple-800/20">
                      <CardContent className="p-6">
                        ...
                        <ul className="space-y-2 text-sm text-purple-800 dark:text-purple-200">
                          ...
                          <li className="flex items-center gap-2">
                            <Check className="w-4 h-4" /> Template:{" "}
                            {
